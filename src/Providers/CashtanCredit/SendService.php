<?php
    ...
    namespace Artjoker\Cpa\Providers\CashtanCredit;
    ...
    class SendService implements SendServiceInterface
    {
        ...
        {
            $this->config = $config;
            $this->source = LeadSource::CASHTAN_CREDIT;
        }
        ...
        final public function send(Conversion $conversion, array $params = []): Postback
        {
            ...
            $mock = new MockHandler([
                new Response(200, ['X-Foo' => 'Bar'], 'CashtanCredit'),
        ...
        {
            return new Request('GET', 'CashtanCredit');
        }
    }
