...
Всі сервіси (ліди, конверсії, парсери) автоматично працюють з усіма активними мережами (з конфігу та БД). Для інтеграції з новою мережею достатньо додати її у БД, і вона буде доступна для використання, якщо для неї є відповідний парсер/сервіс.
